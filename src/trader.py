...
print(f"🔍 DEBUG ENV CHECK: BINANCE_API_KEY={BINANCE_API_KEY} BINANCE_API_SECRET={BINANCE_API_SECRET} BYBIT_API_KEY={BYBIT_API_KEY} BYBIT_API_SECRET={BYBIT_API_SECRET}")
